  ...
  return (
    <div className="bg-slate-400 xl:place-content-center py-20 px-20 grid gap-10 lg:grid-cols-2 xl:grid-cols-3 min-h-screen">
      <div className="bg-white flex flex-col justify-between p-10 rounded-3xl shadow-xl">
        <span className="font-semibold text-3xl ">SelectItem</span>
        <ul>
      ...
      <div className="bg-white p-10 rounded-3xl shadow-xl lg:col-span-2 xl:col-span-1">
        ...
        <div className="flex flex-col">
          ...
          <div className="mt-3 mb-5 flex justify-between item-center">
            ...
            <div className="flex items-center space-x-5">
              <button className="p-1.5 rounded-lg bg-blue-200 flex justify-center item-center aspect-square w-8 text-xl text-gray-500">
                -
              </button>
              <span>1</span>
              <button className="p-1.5 rounded-lg bg-blue-200 flex justify-center item-center aspect-square w-8 text-xl text-gray-500">
